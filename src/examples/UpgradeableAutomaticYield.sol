    ...
    UUPSUpgradeable
{
    ...
    // BLAST CONTRACTS
    address public BLAST_GAS_YIELD_CONTRACT;
    address public BLAST_POINTS_CONTRACT;
    ...
    function initialize() public initializer {
      ...
      BLAST_GAS_YIELD_CONTRACT = 0x4300000000000000000000000000000000000002;
      BLAST_POINTS_CONTRACT = 0x2536FE9ab3F511540F2f9e2eC2A805005C3Dd800;
    ...
    /*
      ...
      this failsafe in the contract. In case the Blast contract changes, 
      we need a way to trigger the configuration again.
    */
